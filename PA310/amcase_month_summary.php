	...
	<table class="table table-bordered w-100">
		<thead>
			<tr class="text-center">
				<th scope="col" class="size14 bg-aqua text-nowrap" style="padding: 10px 0;width:120px;"><b>設備名稱/日期</b></th>
...
EOT;
	...
	while ($row=$mDB->fetchRow(2)) {
		...
		//$show_caption = "<div class=\"w-100\"><div class=\"inline float-left text-left mr-1\" style=\"max-width:90px;\">".$description."</div><div class=\"inline text-right text-nowrap float-right\">(".$ammeter_id."-".$node_no.")</div></div>";
...
$show_report=<<<EOT
<div class="mytable" style="width:100%;background-color:#fff;padding: 40px 10px 0 10px;opacity: 0.9;">
	<div class="myrow">
		<div class="mycell" style="width:20%;padding: 10px;vertical-align: bottom;">
			<a href="/">$home</a>
		</div>
		<div class="mycell" style="width:60%;padding: 30px 5px 10px 5px;text-align:center;">
			<h3><b>$mess_title</b></h3>
		</div>
		<div class="mycell" style="width:20%;text-align:right;padding: 10px;vertical-align: bottom;">
			<div class="form_btn_div" style="width:auto;position:fixed;top: 5px; right:5px;z-index: 9999;">
				<button id="close" class="btn btn-danger btn-lg print" type="button" onclick="window.close();" style="padding: 10px 20px;"><i class="bi bi-power"></i>&nbsp;關閉</button>
			</div>
		</div>
	</div>
</div>
...
$show_report=<<<EOT
<div style="width:100%;">
	<div class="form_btn_div" style="width:auto;position:fixed;top: 2px; right:2px;z-index: 9999;">
		<button id="close" class="btn btn-danger btn-lg print" type="button" onclick="window.close();" style="padding: 10px 20px;"><i class="bi bi-power"></i>&nbsp;關閉</button>
	</div>
	<div class="mytable" style="width:100%;background-color:#fff;opacity: 0.9;">
		<div class="myrow">
			<div class="mycell" style="width:100%;padding: 25px 5px 5px 5px;text-align:left;">
				<h4><b>$mess_title</b></h4>
			</div>
		</div>
	</div>
	<hr class="half-rule" style="margin: 0;padding:0;border-color:$panel_bgcolor;">
