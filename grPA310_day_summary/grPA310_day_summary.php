...
<table class="table table-bordered">
	<thead>
		<tr class="text-center">
			...
			<th scope="col" class="size14 bg-silver text-nowrap" style="padding: 10px 0;width:100px;"><b>最高需量 KW</b></th>
			<th scope="col" class="size14 bg-silver text-nowrap" style="padding: 10px 0;width:100px;"><b>千瓦小時 KWH</b></th>
			<th scope="col" class="size14 bg-silver text-nowrap" style="padding: 10px 0;width:100px;"><b>千伏安時 KVAH</b></th>
			<!--
			...
			<div class="container-fluid text-center" style="width:100%;padding: 10px;">
				...
				<div class="col-xs-12 col-md-6 text-left" style="padding:2px 0 15px 20px;">
					...
					<div class="btn-group" role="group">
						...
						<a role="button" class="btn btn-success" href="/index.php?ch=grPA310_day_summary_excel&choice_date=$choice_date&t=$t&auto_seq=$auto_seq&fm=$fm"><i class="far fa-file-excel"></i>&nbsp;$Export_Excel</a>
